...
class _AdminService implements AdminService {
  ...
  Future<AdminDashboardData> getDashboardData() async {
    ...
    final _options = _setStreamType<AdminDashboardData>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late AdminDashboardData _value;
    try {
      _value = AdminDashboardData.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<AdminDashboardData> getRealtimeDashboardData() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<PackageModel> getProductById(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PackageModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PackageModel _value;
    try {
      _value = PackageModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<PackageModel> createProduct(PackageModel product) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<void> addToBlacklist(
    String id,
    Map<String, dynamic> blacklistData,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(blacklistData);
    final _options = _setStreamType<void>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
  ...
  Future<Map<String, dynamic>> getAIRecommendationAnalytics({
    ...
    final _options = _setStreamType<Map<String, dynamic>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/admin/analytics/ai-recommendations',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<Map<String, dynamic>> getCustomerSatisfactionAnalytics() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<Map<String, dynamic>>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/admin/analytics/customer-satisfaction',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<Map<String, dynamic>> getRetentionAnalytics() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
